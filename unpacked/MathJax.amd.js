...
define('MathJax/MathJax',['require', 'module'], function(require, module){
...
(function (BASE) {
  ...
  //
  var EVAL = function (code) {return eval(code)}
  var TESTEVAL = function () {
    //deactivated test because it pollutes the global scope
...
(function (BASE) {
  ...
  var timeout = 30;
  if(requirejs && requirejs.s && requirejs.s.contexts && requirejs.s.contexts._.config && requirejs.s.contexts._.config.waitSeconds){
        timeout = requirejs.s.contexts._.config.waitSeconds;
  }
  var PATH = {};
  ...
  BASE.Ajax = {
    ...
    timeout: timeout*1000,   // timeout for loading of files (15 seconds)
    ...
    loader: {
      ...
      JS: function (file,callback) {
        ...
        var timeout = BASE.Callback(["loadTimeout",this,file]);
          ...
          var amdfile = name.replace(/[\[\]]/g, '')
                     .replace(/\.js$/, '');
          require([amdfile], function(fileModule){
...
(function (BASE) {
  ...
  var assetDir = HUB.config.root || '';
  if(!assetDir && module.config() && module.config().root){
    assetDir = module.config().root;
  }
...
(function (BASE) {
 ...
 STARTUP.params.delayStartupUntil = 'configured';

  //load the default config
  MathJax.Hub.Config({
      config: ["MMLorHTML.js"],
    extensions: ["tex2jax.js","mml2jax.js","asciimath2jax.js","MathEvents.js","MathZoom.js","toMathML.js","TeX/noErrors.js","TeX/noUndefined.js","TeX/AMSmath.js","TeX/AMSsymbols.js","fast-preview.js","AssistiveMML.js"],
  ...
  if(typeof conf.config === 'object'){
    MathJax.Hub.Config(conf.config);
  }
